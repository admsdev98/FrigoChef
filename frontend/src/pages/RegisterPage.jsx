...
export function RegisterPage({ supabaseClient }) {
    ...
    return (
        <div
            ref={containerRef}
            className="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden"
            style={{
